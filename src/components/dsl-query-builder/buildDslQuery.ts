      ...
      case 'string':
        ...
        switch (op) {
          case '==':
            ...
            break;
          case '!=':
            sb.neq(val as string);
            break;
          case '@contains':
            sb.contains(val as string);
            break;
          case '@ncontains':
            sb.ncontains(val as string);
            break;
          case '@startswith':
            sb.startswith(val as string);
            break;
          case '@endswith':
            sb.endswith(val as string);
            break;
          case '@in':
            sb.in(parseMultiValue(val));
            break;
          case '@nin':
            sb.nin(parseMultiValue(val));
            break;
          case '@isnull':
            sb.isNull();
            break;
      ...
      case 'long':
        ...
        switch (op) {
          ...
          case '<=':
            ...
            break;
          case '@between':
            nb.between(Number(val), Number(val2));
            break;
          case '@in':
            nb.in(parseMultiNumber(val));
            break;
          case '@nin':
            nb.nin(parseMultiNumber(val));
            break;
          case '@isnull':
            nb.isNull();
            break;
      ...
      case 'date':
        ...
        switch (op) {
          case '==':
            ...
            break;
          case '!=':
            db.neq(val as string);
            break;
          case '>':
            db.gt(val as string);
            break;
          case '>=':
            db.gte(val as string);
            break;
          case '<':
            db.lt(val as string);
            break;
          case '<=':
            db.lte(val as string);
            break;
          case '@between':
            db.between(val as string, val2 as string);
            break;
          case '@in':
            db.in(parseMultiValue(val));
            break;
          case '@nin':
            db.nin(parseMultiValue(val));
            break;
          case '@isnull':
            db.isNull();
            break;
